        ...
        <>
            ...
            <nav className='flex w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 items-center justify-between z-50'>
                ...
                <div className='flex gap-4 items-center'>
                    ...
                    <button onClick={() => setShowMenu(true)} className='block md:hidden cursor-pointer ml-4'>
                ...
                <ul className={`flex md:hidden flex-col gap-4 items-center py-10 fixed top-0 botton-0 w-48 max-w-1/2 z-50
                               ...
                               ${showMenu ? 'right-0' : '-right-99'}`}>
                    <Image src={assets.close_black} alt="" onClick={() => setShowMenu(false)}
                    className='w-5 cursor-pointer absolute top-0 bottom-0 right-0 m-4' />

                    <li><a onClick={() => setShowMenu(false)} className='font-ovo' href="#top">Home</a></li>
                    <li><a onClick={() => setShowMenu(false)} className='font-ovo font-medium' href="#work">My Work</a></li>
                    <li><a onClick={() => setShowMenu(false)} className='font-ovo' href="#services">Services</a></li>
                    <li><a onClick={() => setShowMenu(false)} className='font-ovo' href="#skills">Skills</a></li>
                    <li><a onClick={() => setShowMenu(false)} className='font-ovo' href="#contact">Contact Me</a></li>
                </ul>
